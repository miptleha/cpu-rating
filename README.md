...
| <h3>CPU (iGPU)</h3> | **Core/Threads** | **Freq GHz** | **L2+L3** | **TDP** | **CB23 SC** | **CB23 MC** | **Time Spy GPU** | **Price (USD)** |
|------------------------------------|-----------|-----------|----------|-------|---------|---------|--------------|-------|
...
| <h3 align="center" text-align="center">CPU (iGPU)</h3>  | **Core/Threads** | **Freq GHz** | **L2+L3** | **TDP** | **CB23 SC** | **CB23 MC** | **Time Spy GPU** | **Price (USD)** |
